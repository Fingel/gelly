...
glib::wrapper! {
    pub struct FullPlayerBar(ObjectSubclass<imp::FullPlayerBar>)
...
impl Default for FullPlayerBar {
    fn default() -> Self {
        Self::new()
    }
}
...
mod imp {
    ...
    #[template(resource = "/io/m51/Gelly/ui/player_bar/full_player_bar.ui")]
    #[properties(wrapper_type = super::FullPlayerBar)]
    pub struct FullPlayerBar {
        #[template_child]
    ...
    impl ObjectSubclass for FullPlayerBar {
        const NAME: &'static str = "GellyFullPlayerBar";
        type Type = super::FullPlayerBar;
    ...
    impl ObjectImpl for FullPlayerBar {
        fn constructed(&self) {
    ...
    impl BinImpl for FullPlayerBar {}
    impl WidgetImpl for FullPlayerBar {
    ...
    impl PlayerImp for FullPlayerBar {
